...
export type Book = {
  ...
  readingStateCurrentState?: Maybe<ReadingStateState>;
...
export type BookDetailsFragment = (
  { __typename: 'Book' }
  & Pick<Book, 'id' | 'lastMetadataUpdatedAt' | 'title' | 'creator' | 'language' | 'date' | 'publisher' | 'subject' | 'downloadState' | 'downloadProgress' | 'readingStateCurrentBookmarkLocation' | 'readingStateCurrentBookmarkProgressUpdatedAt' | 'readingStateCurrentBookmarkProgressPercent' | 'readingStateCurrentState' | 'createdAt'>
);
...
export type BookAssociationIdsFragment = (
  { __typename?: 'Book' }
  & { tags?: Maybe<Array<Maybe<(
    { __typename?: 'Tag' }
    & Pick<Tag, 'id'>
...
export type MutationEditBookMutationVariables = Exact<{
  id: Scalars['ID'];
  lastMetadataUpdatedAt?: Maybe<Scalars['Float']>;
  readingStateCurrentBookmarkLocation?: Maybe<Scalars['String']>;
  readingStateCurrentBookmarkProgressPercent?: Maybe<Scalars['Float']>;
...
export type MutationEditBookMutation = (
  { __typename?: 'Mutation' }
  & { editBook?: Maybe<(
    { __typename?: 'Book' }
    & Pick<Book, 'id'>
...
export type QueryFullLinkQueryVariables = Exact<{
  id: Scalars['ID'];
}>;


export type QueryFullLinkQuery = (
  { __typename?: 'Query' }
  & { link?: Maybe<(
    { __typename?: 'Link' }
    & Pick<Link, 'id' | 'resourceId'>
...
export type BookFieldPolicy = {
	...
	readingStateCurrentState?: FieldPolicy<any> | FieldReadFunction<any>,
...
export const MutationEditBookDocument: DocumentNode<MutationEditBookMutation, MutationEditBookMutationVariables> = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"MutationEditBook"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}},"directives":[]},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"lastMetadataUpdatedAt"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Float"}},"directives":[]},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"readingStateCurrentBookmarkLocation"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}},"directives":[]},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"readingStateCurrentBookmarkProgressPercent"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Float"}},"directives":[]},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"readingStateCurrentState"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"ReadingStateState"}},"directives":[]}],"directives":[],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"editBook"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"Argument","name":{"kind":"Name","value":"lastMetadataUpdatedAt"},"value":{"kind":"Variable","name":{"kind":"Name","value":"lastMetadataUpdatedAt"}}},{"kind":"Argument","name":{"kind":"Name","value":"readingStateCurrentBookmarkLocation"},"value":{"kind":"Variable","name":{"kind":"Name","value":"readingStateCurrentBookmarkLocation"}}},{"kind":"Argument","name":{"kind":"Name","value":"readingStateCurrentBookmarkProgressPercent"},"value":{"kind":"Variable","name":{"kind":"Name","value":"readingStateCurrentBookmarkProgressPercent"}}},{"kind":"Argument","name":{"kind":"Name","value":"readingStateCurrentState"},"value":{"kind":"Variable","name":{"kind":"Name","value":"readingStateCurrentState"}}}],"directives":[],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"},"arguments":[],"directives":[]}]}}]}}]};
...
export const QueryFullLinkDocument: DocumentNode<QueryFullLinkQuery, QueryFullLinkQueryVariables> = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"QueryFullLink"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}},"directives":[]}],"directives":[],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"link"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"directives":[],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"},"arguments":[],"directives":[]},{"kind":"Field","name":{"kind":"Name","value":"resourceId"},"arguments":[],"directives":[]}]}}]}}]};
