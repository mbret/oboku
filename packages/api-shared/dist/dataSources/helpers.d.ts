...
export declare const createHelpers: (dataSourceId: string, refreshBookMetadata: ({ bookId }: {
    ...
    findOne: <M extends "link" | "datasource" | "book" | "tag" | "obokucollection", D extends ("link" extends M ? import("@oboku/shared").LinkDocType : never) | ("datasource" extends M ? import("@oboku/shared").DataSourceDocType : never) | ("book" extends M ? import("@oboku/shared").BookDocType : never) | ("tag" extends M ? import("@oboku/shared").TagsDocType : never) | ("obokucollection" extends M ? import("@oboku/shared").CollectionDocType : never)>(model: M, query: SafeMangoQuery<D>) => Promise<({
        _id: string;
        _rev: string;
    } & D) | null>;
    find: <M_1 extends "link" | "datasource" | "book" | "tag" | "obokucollection", D_1 extends ("link" extends M_1 ? import("@oboku/shared").LinkDocType : never) | ("datasource" extends M_1 ? import("@oboku/shared").DataSourceDocType : never) | ("book" extends M_1 ? import("@oboku/shared").BookDocType : never) | ("tag" extends M_1 ? import("@oboku/shared").TagsDocType : never) | ("obokucollection" extends M_1 ? import("@oboku/shared").CollectionDocType : never)>(model: M_1, query: SafeMangoQuery<D_1>) => Promise<{
        _id: string;
        _rev: string;
    }[]>;
    atomicUpdate: <M_2 extends "link" | "datasource" | "book" | "tag" | "obokucollection", K extends ("link" extends M_2 ? import("@oboku/shared").LinkDocType : never) | ("datasource" extends M_2 ? import("@oboku/shared").DataSourceDocType : never) | ("book" extends M_2 ? import("@oboku/shared").BookDocType : never) | ("tag" extends M_2 ? import("@oboku/shared").TagsDocType : never) | ("obokucollection" extends M_2 ? import("@oboku/shared").CollectionDocType : never)>(model: M_2, id: string, cb: (oldData: createNano.DocumentGetResponse & K) => Partial<K>) => Promise<createNano.DocumentInsertResponse>;
    create: <M_3 extends "link" | "datasource" | "book" | "tag" | "obokucollection", D_2 extends ("link" extends M_3 ? import("@oboku/shared").LinkDocType : never) | ("datasource" extends M_3 ? import("@oboku/shared").DataSourceDocType : never) | ("book" extends M_3 ? import("@oboku/shared").BookDocType : never) | ("tag" extends M_3 ? import("@oboku/shared").TagsDocType : never) | ("obokucollection" extends M_3 ? import("@oboku/shared").CollectionDocType : never)>(model: M_3, data: Pick<D_2, Exclude<keyof D_2, "_id" | "_rev" | "rx_model">>) => Promise<createNano.DocumentInsertResponse>;
