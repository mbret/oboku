...
export const createNavigator = ({ readingItemManager, context, pagination, element }) => {
    ...
    const calculateOffsetForPageInReadingItem = (pageIndex, readingItem) => {
        ...
        if ((lastUserExpectedNavigation === null || lastUserExpectedNavigation === void 0 ? void 0 : lastUserExpectedNavigation.type) === 'turned-prev-chapter') {
    ...
    const calculateClosestOffsetForCfiInReadingItem = (cfi, readingItem) => {
        var _a;
        // console.log(cfi)
        const cfiFoundNode = readingItem.resolveCfi(cfi);
        const offsetOfNodeInReadingItem = (((_a = cfiFoundNode === null || cfiFoundNode === void 0 ? void 0 : cfiFoundNode.parentElement) === null || _a === void 0 ? void 0 : _a.getBoundingClientRect().x) || 0);
     ...
     */
    const navigateToOffsetOrCfi = (offsetOrCfi, { allowReadingItemChange, startOfReadingItem } = {}) => {
        ...
        if (!newReadingItem || !potentialNewReadingItem)
            return;
    ...
    const getOffsetInCurrentReadingItem = (readingOrderViewOffset, readingItem) => {
